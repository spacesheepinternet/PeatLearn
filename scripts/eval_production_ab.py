...
Usage:
    python scripts/eval_production_ab.py
    python scripts/eval_production_ab.py --api-key AIzaSy...   # override Gemini key
    python scripts/eval_production_ab.py --index-b-only        # skip Index A (no API quota needed)
"""
