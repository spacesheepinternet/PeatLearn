...
Usage:
    python scripts/eval_ab_indexes.py
    python scripts/eval_ab_indexes.py --questions data/eval/questions_adversarial_v1.jsonl
    python scripts/eval_ab_indexes.py --top-k 10 --dry-run
"""
