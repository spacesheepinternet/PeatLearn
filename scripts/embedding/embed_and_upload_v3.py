...
Usage:
    python scripts/embedding/embed_and_upload_v3.py
    python scripts/embedding/embed_and_upload_v3.py --jsonl data/corpus_v3/corpus_v3_<timestamp>.jsonl
    python scripts/embedding/embed_and_upload_v3.py --dry-run
    python scripts/embedding/embed_and_upload_v3.py --resume          # skip already-uploaded IDs
"""
