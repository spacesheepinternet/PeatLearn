...
Usage:
    python scripts/embedding/dedup_processed_files.py              # dry-run (default)
    python scripts/embedding/dedup_processed_files.py --apply       # overwrite files
    python scripts/embedding/dedup_processed_files.py --threshold 150  # custom bloat %
"""
