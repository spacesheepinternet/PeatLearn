...
Usage:
    python scripts/embedding/reembed_deduped_files.py --scan          # find vectors to delete
    python scripts/embedding/reembed_deduped_files.py --delete        # delete old vectors
    python scripts/embedding/reembed_deduped_files.py --embed-upload  # re-embed and upload
    python scripts/embedding/reembed_deduped_files.py --all           # do everything
"""
