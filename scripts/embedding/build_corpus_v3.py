...
Usage:
    ...
    python scripts/embedding/build_corpus_v3.py --skip-llm          # keyword-only topics
    python scripts/embedding/build_corpus_v3.py --min-tokens 15     # lower garbage threshold
"""
