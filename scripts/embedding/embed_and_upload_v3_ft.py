...
Usage:
    python scripts/embedding/embed_and_upload_v3_ft.py
    python scripts/embedding/embed_and_upload_v3_ft.py --jsonl data/corpus_v3/corpus_v3_<timestamp>.jsonl
    python scripts/embedding/embed_and_upload_v3_ft.py --dry-run
    python scripts/embedding/embed_and_upload_v3_ft.py --resume
    python scripts/embedding/embed_and_upload_v3_ft.py --batch-size 64
"""
