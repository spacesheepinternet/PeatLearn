...
Usage:
    python scripts/embedding/reembed_full_corpus.py              # embed + upload (resumable)
    python scripts/embedding/reembed_full_corpus.py --dry-run     # parse pairs, show stats, don't embed
    python scripts/embedding/reembed_full_corpus.py --reset       # clear progress and start over
"""
