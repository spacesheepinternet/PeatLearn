...
- Recent council transcripts in this folder
...
3. A clear instruction: respond independently. Do not hedge. Do not try to be balanced. Lean fully into your assigned perspective. Your job is to represent your angle as strongly as possible. The synthesis comes later.
...
The chairman produces the final council output with this structure:

**COUNCIL VERDICT**

1. **Where the council agrees** — points that multiple advisors converged on independently. High-confidence signals.
...
3. **Blind spots the council caught** — things that only emerged through the peer review round.
